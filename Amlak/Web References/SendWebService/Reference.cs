...
namespace Amlak.SendWebService {
    using System;
    ...
    public partial class Send : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetSMSQueueDeliveriesOperationCompleted;
        ...
        /// <remarks/>
        public Send() {
            this.Url = global::Amlak.Properties.Settings.Default.Amlak_SendWebService_Send;
        ...
        /// <remarks/>
        public event GetSMSQueueDeliveriesCompletedEventHandler GetSMSQueueDeliveriesCompleted;
        ...
        public int SendSms2(string username, string password, string[] to, string from, string text, bool isflash, string udh, ref long[] recId, [System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] ref byte[] status, ref int filterId) {
            ...
            recId = ((long[])(results[1]));
            status = ((byte[])(results[2]));
            filterId = ((int)(results[3]));
            return ((int)(results[0]));
        }
        
        /// <remarks/>
        public void SendSms2Async(string username, string password, string[] to, string from, string text, bool isflash, string udh, long[] recId, byte[] status, int filterId) {
            this.SendSms2Async(username, password, to, from, text, isflash, udh, recId, status, filterId, null);
        }
        
        /// <remarks/>
        public void SendSms2Async(string username, string password, string[] to, string from, string text, bool isflash, string udh, long[] recId, byte[] status, int filterId, object userState) {
            ...
            this.InvokeAsync("SendSms2", new object[] {
                        ...
                        recId,
                        status,
                        filterId}, this.SendSms2OperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetSMSQueueDeliveries", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public int[] GetSMSQueueDeliveries(long[] Id, string username, string password) {
            object[] results = this.Invoke("GetSMSQueueDeliveries", new object[] {
                        Id,
                        username,
                        password});
            return ((int[])(results[0]));
        ...
        /// <remarks/>
        public void GetSMSQueueDeliveriesAsync(long[] Id, string username, string password) {
            this.GetSMSQueueDeliveriesAsync(Id, username, password, null);
        }
        
        /// <remarks/>
        public void GetSMSQueueDeliveriesAsync(long[] Id, string username, string password, object userState) {
            if ((this.GetSMSQueueDeliveriesOperationCompleted == null)) {
                this.GetSMSQueueDeliveriesOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetSMSQueueDeliveriesOperationCompleted);
            }
            this.InvokeAsync("GetSMSQueueDeliveries", new object[] {
                        Id,
                        username,
                        password}, this.GetSMSQueueDeliveriesOperationCompleted, userState);
        }
        
        private void OnGetSMSQueueDeliveriesOperationCompleted(object arg) {
            if ((this.GetSMSQueueDeliveriesCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetSMSQueueDeliveriesCompleted(this, new GetSMSQueueDeliveriesCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void GetSMSQueueDeliveriesCompletedEventHandler(object sender, GetSMSQueueDeliveriesCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetSMSQueueDeliveriesCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetSMSQueueDeliveriesCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
